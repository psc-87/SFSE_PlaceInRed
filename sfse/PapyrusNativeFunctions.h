...
public:
	...
	struct ParameterInfo
	{
		...
		DEFINE_MEMBER_FN(GetParam, u64 *, 0x0337A74C, u32 idx, BSFixedString * nameOut, u64 * typeOut);
	};
	...
	DEFINE_MEMBER_FN(Impl_Invoke, u32, 0x0337A424, u64 unk0, u64 unk1, VMClassRegistry * registry, VMState * unk3);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x10
	DEFINE_MEMBER_FN(Impl_Fn10, BSFixedString *, 0x0337A7B4);
	DEFINE_MEMBER_FN(Impl_GetParamInfo, bool, 0x0337A850, u32 idx, void * out);
	DEFINE_MEMBER_FN(Impl_Fn15, void *, 0x0337A7BC, u64 arg0, u64 arg1);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x0337A2A8, const char * fnName, const char * className, u8 unk0, u32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x0337A364);	// same as NativeFunctionBase dtor
